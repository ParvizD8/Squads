        ...
        <main class="max-w-lg mx-auto">
            <form method="POST" action="/member" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full rounded" type="text" name="name" id="name" value="" required>
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full rounded" type="number" name="level" id="level" value="" required>
