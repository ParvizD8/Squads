<x-layout>
    <section class="px-6 py-8 mt-20">
        <main class="max-w-lg mx-auto">
            <form method="POST" action="/team/{{ $team->id }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full rounded" type="text" name="name" id="name" value="{{ $team->name }}" required>
